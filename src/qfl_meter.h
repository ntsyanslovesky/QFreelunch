...
class QMeter : public QWidget {
  ...
  Q_PROPERTY(
      int precisionNumeric READ precisionNumeric WRITE setPrecisionNumeric)
  ...
  Q_PROPERTY(
      bool enableThreshold READ enableThreshold WRITE setThresholdEnabled)
  Q_PROPERTY(
      double beginValidValue READ beginValidValue WRITE setBeginValidValue)
  Q_PROPERTY(double endValidValue READ endValidValue WRITE setEndValidValue)
  Q_PROPERTY(
      bool enableValidWindow READ enableValidWindow WRITE setEnableValidWindow)
  Q_PROPERTY(double beginWarningValue READ beginWarningValue WRITE
                 setBeginWarningValue)
  Q_PROPERTY(
      double endWarningValue READ endWarningValue WRITE setEndWarningValue)
  Q_PROPERTY(bool enableWarningWindow READ enableWarningWindow WRITE
                 setEnableWarningWindow)
  Q_PROPERTY(bool enableNumericIndicator READ enableNumericIndicator WRITE
                 setNumericIndicatorEnabled)
